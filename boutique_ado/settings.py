...
ALLOWED_HOSTS = ['kera-cudmore-boutique-ado.herokuapp.com', 'localhost']
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'kera-cudmore-boutique-ado'
...
STRIPE_WH_SECRET = os.getenv('STRIPE_WH_SECRET', 'python')
